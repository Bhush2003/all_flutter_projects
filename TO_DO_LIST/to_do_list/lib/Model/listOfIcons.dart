...
zoom_out_rounded
zoom_out_sharp''';
List<IconData> usedList = [];
  List<IconData> listOfIcons() {
    

    String m = s.replaceAll(RegExp(r'\n'), " ,Icons.");
    // print(m);

    List<IconData> listOfIcons = m.split(",") as List<IconData>;
    for (final x in listOfIcons) {
      usedList.add(x as IconData);
    }
    return usedList;
  }

  List<IconData> mostUsedIconsList1 = [
  ...
  List<IconData> mostUsedIcons() {
    
    // List<IconData> mostUsedIconsList = mostUsedIconsList1 as List<IconData>;
    return mostUsedIconsList1;
  }
}
